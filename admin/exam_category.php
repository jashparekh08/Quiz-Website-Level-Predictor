                            ...
                            <div class="card">
                                <div class="card-header"><strong>Add Exam Categories</strong></div>
                                    <div class="card-body card-block">
                                        <div class="form-group"><label for="company" class=" form-control-label">New Exam Catagory</label><input type="text" name="examname" placeholder="Add Exam Category" class="form-control"></div>
...
if(isset($_POST["submit1"]))
{
    ...
    <script type="text/javascript">
        ...
        window.location.href=window.location.href;  // when add exam catagory then it will show in exam table
    </script>
    <?php
}
?>
